...
export default function UserDetails(props) {
  ...
  const closeWindow = () => setSelectedUser(null);
        ...
        <div className="detail-container">
          ...
          <div className="content">
            <div className="image-container">
              <img src={selectedUser.imageUrl} alt="" className="image" />
            </div>
            <div className="user-details">
              ...
              <p>
                Created on: <strong>{selectedUser.createdAt}</strong>
              </p>
              <p>
                Modified on: <strong>{selectedUser.updatedAt}</strong>
              </p>
            </div>
          </div>
        </div>
